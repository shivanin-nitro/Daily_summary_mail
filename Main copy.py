...
CC_EMAILS = ["zodiac@getnitro.co","pratik@getnitro.co","parijat@getnitro.co","shilpa@getnitro.co","shivani.n@getnitro.co"]
...
def run_pipeline():
    ...
    for brand in ALL_BRANDS:
        ...
        for recipient_email in recipients:
            ...
            WEB_APP_URL =  "https://script.google.com/macros/s/AKfycbzG4ul45vGCNJkDqSkCP7UOb3F2_xbl4z_DvC4UixQdZ05Px9krzavBeWHl7--yILdoSQ/exec"
